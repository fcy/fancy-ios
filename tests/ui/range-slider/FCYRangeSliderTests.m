...
@interface FCYRangeSliderTests : SenTestCase {
    FCYRangeSlider *rangeSlider;
}
@end

@implementation FCYRangeSliderTests
...
- (void)setRangeValueWithAcceptOnlyNonFractionValuesYes {
    ...
    rangeSlider.rangeValue = FCYRangeSliderValueMake(0.87, 9.2);
